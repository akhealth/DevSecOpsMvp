...
This communication plan can and should be refined.  In particular, the product team will add case studies as we practice.  Additionally, we will update and use the [Unblocking Opportunities](#unblocking-opportunities) section content to identify and implement challenges and opportunites, as needs/sticking points arise in the work managed via the product team's backlog.  While theoretical challenges and opportunities can be useful, challenges and opportunities we actually experience should be the first focus and primary driver of proposed improvements.
